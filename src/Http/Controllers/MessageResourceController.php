...
namespace Cms_Framework_Seed\Message\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Form;
use Cms_Framework_Seed\Message\Http\Requests\MessageRequest;
use Cms_Framework_Seed\Message\Interfaces\MessageRepositoryInterface;
use Cms_Framework_Seed\Message\Models\Message;
...
class MessageResourceController extends BaseController
{
    ...
    public function index(MessageRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Message\Repositories\Presenter\MessageListPresenter::class)
    ...
    public function destroy(MessageRequest $request, Message $message)
    {
        try {
            ...
            $this->repository->pushCriteria(new \Cms_Framework_Seed\Message\Repositories\Criteria\MessageAdminCriteria());
            $inbox_count = $this->repository->msgCount('Inbox');
    ...
    public function list(MessageRequest $request)
    {
        $messages['data'] = $this->repository
            ->pushCriteria(\Cms_Framework_Seed\Message\Repositories\Criteria\MessageResourceCriteria::class)
            ->mailList();
    ...
    public function outbox(MessageRequest $request)
    {
        ...
        $messages['data'] = $this->repository
            ->pushCriteria(\Cms_Framework_Seed\Message\Repositories\Criteria\MessageOutboxCriteria::class)
            ->mailList();
